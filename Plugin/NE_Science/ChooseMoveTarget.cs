...
namespace NE_Science
{
    ...
    class ChooseMoveTarget : MonoBehaviour
    {
        ...
        internal void showDialog(List<Part> f_lTargets, Part f_pSource, Action<Part> f_aOnPartSelectedCallback)
        {
            ...
            smInfo = ScreenMessages.PostScreenMessage(Localizer.Format("#ne_Select_a_part_to_transfer_1_to_ESC_to_cancel", "the Experiment"),
